...
abstract class AbstractDaoTest extends Module with PlaySpecification with Mockito with AfterAll {
  protected val inMemoryDatabaseConfiguration: Map[String, Any] = Map(
